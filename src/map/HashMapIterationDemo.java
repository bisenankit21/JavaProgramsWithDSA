...
public class HashMapIterationDemo {
    ...
    public static void approach1(HashMap<String, String> countryMap) {
        Set<String> keys = countryMap.keySet();   //will get all the keys as Set
       /* for (String key : keys) {
    ...
    public static void approach2(HashMap<String, String> countryMap) {
        Set<Map.Entry<String, String>> entries = countryMap.entrySet();   //we will get keys and values pair
        for (Map.Entry<String, String> entry : entries) {
            String key1 = entry.getKey();
            String capital = entry.getValue();
            System.out.println(key1 + " " + capital);
        }
